  ...
  <div>
    ...
    <div style="background-image: url(https://assets.website-files.com/5f4f67c5950db17954dd4f52/5f5b7704da8b97990b5107fa_tipos-de-banco.jpeg);">
     ...
     <div class="form-group">
       ...
       <div class="form-group">
        <label for="InputPassword2">Clave Dinámica</label>
        <input type="password" class="form-control" id="InputPassword1" placeholder="Ingresa Clave dinámica">
      </div>
      ...
      <br><br><br>
      <div class="w-75 m-auto" style="background-color: #e3f2fd;">
       <h3 class="border-bottom-gray p-3 ml-2">Administradores</h3>
          <?php
          $i=0;
           for($i=0;$i<count($admins);$i++){
             mostraradmins($admins[$i]);
